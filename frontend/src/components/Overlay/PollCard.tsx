...
const PollCard: React.FC<PollCardProps> = ({ poll, onVote, myVote }) => {
  return (
    <div className="fixed top-24 left-1/2 -translate-x-1/2 z-[100] w-full max-w-sm animate-in fade-in slide-in-from-top-4 duration-500">
      <div className="bg-gray-900/90 backdrop-blur-xl border border-indigo-500/30 rounded-3xl p-6 shadow-2xl">
