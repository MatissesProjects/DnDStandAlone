...
const GMToolbox: React.FC<GMToolboxProps> = ({
  ...
  onClearHistory, onMoveToScene, onAddToInitiative, onToggleFog, onPromote, targetScene, onSetTargetScene, showSpinner, onToggleSpinner, customForge, onCaptureSelection, onDeleteCustomToken, onRenameCustomToken
}) => {
